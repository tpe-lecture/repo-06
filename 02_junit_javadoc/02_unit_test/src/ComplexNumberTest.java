...
public class ComplexNumberTest {
    ...
    public void testSubtraktion() {
        ...
        // (2 + 11i) - (4 + -5i) = (-2 +  16i)
    	ComplexNumber a = new ComplexNumber(4,-5);
    	ComplexNumber b = new ComplexNumber(2,16);
    ...
    public void testBetrag() {
    	...
    	assertEquals(new ComplexNumber(5,0), a.abs());
    	assertEquals(new ComplexNumber(3,0), b.abs());
    ...
    public void testPotenz() {
    	...
    	assertEquals(new ComplexNumber(), a.power(2));
    	assertEquals(new ComplexNumber(), a.power(3));
    	assertEquals(new ComplexNumber(), a.power(6));
